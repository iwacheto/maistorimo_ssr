    ...
    <div id="titlebar">
      <div class="row">
        <div class="col-md-12 heading_admin">
          ...
          <a target="_blank" :href="'/#/profile/'+user.id" class="button preview project_link">
            Виж своя Профил
        ...
        <div class="dashboard-list-box margin-top-0">
          ...
          <div class="dashboard-list-box-static">
            ...
            <div class="my-profile">
              ...
              <label>Поща</label>
              <input value v-model="user.vendor_details.email_address" type="text" />
              ...
              <input value v-model="user.vendor_details.contact_person" type="text" />
              <label>
            ...
            <button class="button margin-top-15" @click="saveProfile">Запази промените</button>
          </div>
        </div>
      </div>
        ...
        <div class="dashboard-list-box margin-top-0">
          ...
          <div class="dashboard-list-box-static">
            ...
            <div class="my-profile">
              ...
              <input type="password" v-model="new_password" name="password" v-validate="'required'" />
