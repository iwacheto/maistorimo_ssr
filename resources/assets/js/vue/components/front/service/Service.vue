    ...
    <div class="container">
      <div class="row margin-top-45">
        ...
        <div class="col-lg-9 col-md-8 padding-right-30">
          ...
          <div @click="showContent" v-if="showText" class="show_button">
            Покажи повече
            <i class="fa fa-fw">&#xf078;</i>
          </div>
          <div v-if="!showText" @click="showContent" class="show_button">
            Скрий текста
            <i class="fa fa-fw">&#xf077;</i>
          </div>
          <!-- Fullwidth Section -->
              ...
              <li v-for="( project, index) in projectDetails" :key="index">
                <div class="widget-content">
                  <div class="widget-thumb">
                    <router-link tag="a" :to="'/project/details/' + project.s_project.id">
                      <img :src="project.s_project.main_image" alt />
                    </router-link>
                  </div>
...
.post-content ul.post-meta li::after {
  display: none;
}
.carousel_link:hover {
