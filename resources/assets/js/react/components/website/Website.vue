      ...
      <div class="col-lg-12 col-md-12">
        <div class="dashboard-list-box margin-top-0">
          <h4 class="gray">
            ...
            <button v-else class="button margin-top-15 margin-left-50" @click="openWebsite">
          ...
          <div class="dashboard-list-box-static">
            ...
            <div class="tab-pan" :class="{ 'active show': isActive('home') }">
              ...
              <img v-if="user.website_settings.logo" :src="user.website_settings.logo" />
              <image-uploader
                :preview="true"
            ...
            <div class="tab-pan" :class="{ 'active show': isActive('profile') }">
              ...
              <div class="my-profile">
                ...
                <input value v-model="user.website_settings.home_heading" type="text" />
                ...
                <input value v-model="user.website_settings.bullet_1_heading" type="text" />
                <label>
                ...
                <input value v-model="user.website_settings.bullet_1_content" type="text" />
                ...
                <input value v-model="user.website_settings.bullet_2_heading" type="text" />
                <label>
                ...
                <input value v-model="user.website_settings.bullet_2_content" type="text" />
                ...
                <input value v-model="user.website_settings.bullet_3_heading" type="text" />
                <label>
                ...
                <input value v-model="user.website_settings.bullet_3_content" type="text" />
              </div>
            </div>
            ...
            <div class="tab-pan" :class="{ 'active show': isActive('seo') }">
              <div class="my-profile">
                ...
                <input value v-model="user.website_settings.seo_description" type="text" />
              </div>
            </div>
...
export default {
  data() {
    return {
      errorTexts: [
        {
          text:
            "The website settings.home text may not be greater than 1000 characters.",
          err: "textError"
        },
        {
          text:
            "The website settings.home heading may not be greater than 2 characters.",
          err: "headingError"
        },
        {
          text:
        ...
        {
          text:
            "The website settings.seo title may not be greater than 100 characters",
          err: "seoHeading"
        },
        {
          text:
        ...
        {
          text:
            "The terms.name may not be greater than 255 characters.",
          err: "termsName"
        },
        {
          text:
            "The terms.eik may not be greater than 9 characters.",
          err: "termsEik"
        },
        {
          text:
            "The terms.eik must be at least 9 characters.",
          err: "termsEik"
        },
        {
          text:
            "The terms.address reg may not be greater than 255 characters.",
          err: "termsAddressReg"
        },
        {
          text:
            "The terms.manager may not be greater than 255 characters.",
          err: "termsManager"
        },
        {
          text:
            "The terms.phone must be at least 8.",
          err: "termsPhoneMin"
        },
        {
          text:
            "The terms.phone must be a number.",
          err: "termsPhoneNumber"
        },
        {
          text:
            "The terms.email may not be greater than 255 characters.",
          err: "termsEmail"
        },
        {
          text:
        ...
        {
          text:
            "The terms.address may not be greater than 255 characters.",
          err: "termsAddress"
        },
        {
          text:
            "The terms.description may not be greater than 255 characters.",
          err: "termsDesc"
        },
      ],
  ...
  methods: {
    showErrors() {
      ...
      if (
        this.user.website_settings.about_us &&
        this.user.website_settings.about_us_2
      ) {
    ...
    uploadLogo: function(output) {
      ...
      let self = this;
      window.axios
        .post("/vendor/profile/uploadImage", output)
        .then(({ data }) => {
    ...
    saveWebsite() {
      ...
      window.axios
        ...
        .then(({ data }) => {
          ...
          // this.showErrors();
          this.$refs.mytoast.s(
            "Успешно променихте настройките на Уебсайта Ви!"
          );
        })
        .catch(error => {
