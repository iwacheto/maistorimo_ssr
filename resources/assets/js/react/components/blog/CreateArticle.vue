                    ...
                    <div class="add-listing-section">
                        ...
                        <div class="row with-forms">
                            <div class="col-md-12">
                                ...
                                <span
                                    ...
                                    class="error"
                                >{{article.titleError[0]}} Test</span>
                            </div>
                        </div>
                        ...
                        <div class="row with-forms">
                            ...
                            <div class="col-md-12">
                                ...
                                <span v-if="article.urlError" class="error">{{article.urlError[0]}}</span>
                                <input
                                    class="search-field"
                                    type="text"
...
export default {
    ...
    methods: {
        ...
        async createArticle() {
            ...
            try {
                const res = await axios.post('/vendor/blog/create-article', this.article);

                this.$refs.mytoast.s('Статията бе създадена успешно!');
                setTimeout(() => {
